...
MODO_CONF_HORA:
	...
	//En este modo si funcionan los incrementos y decrementos
    SBIS PINB, PB3
    RCALL SUMAR_MINUTOS
...
ISR_TIMER0_OVF:
    ...
    CPI MODO, 1						//Encender bits cada ciclo
    BREQ MUX_FECHA
    CPI MODO, 3
    BREQ MUX_FECHA
    CPI MODO, 4
...
//Multiplex de digitos en Alarma
D0_A: 
    SBI PORTC, PC1
    MOV R17, A_UNID_HOR
    RJMP ENVIAR_A_PANTALLA
...
ESPERAR_SOLTAR_PB0:
    RCALL DELAY
B_PB0: 
    SBIS PINB, PB0				;Esperar al cambio de boton
    RJMP B_PB0
    RCALL DELAY					;Finalizar cuando se suelte el boton
    RET
...
;Contador 1 s 
    ...
    LDI R16, HIGH(VALOR_TIMER1)
    STS TCNT1H, R16
    LDI R16, LOW(VALOR_TIMER1)			;Valor calculado TCNT1
    STS TCNT1L, R16

    LDI R16, (1<<TOIE1)					;Habilitar interrupciones
    STS TIMSK1, R16
    RET